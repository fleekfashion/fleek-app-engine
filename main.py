...
@app.route('/getUserFaveProductsGrouped', methods=['GET'])
def getUserFaveProductsGrouped():
    res = ufb.getUserFaveProductsGrouped(request.args)
    return jsonify(res)
...
@app.route('/getUserFaveProductIds', methods=['GET'])
def getUserFaveProductIds():
    res = ufb.getUserFaveProductIds(request.args)
    return jsonify(res)
